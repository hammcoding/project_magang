    ...
    <div className="mx-auto max-w-[1200px] px-5 pb-12 pt-8">
      ...
      <div className="mb-8">
        <div className="flex overflow-x-auto rounded border border-gray-300 bg-white shadow-xs">
          ...
          <Link
            href="/antrian-poliklinik"
            className="flex-1 min-w-[160px] px-4 py-3.5 text-center text-[15px] font-bold text-gray-600 hover:bg-gray-50 hover:text-[#004A99] border-r border-gray-300 no-underline whitespace-nowrap"
          >
            Antrian Poliklinik
          </Link>
          <Link
            href="/antrian-farmasi"
            className="flex-1 min-w-[160px] px-4 py-3.5 text-center text-[15px] font-bold text-[#004A99] bg-white border-b-2 border-[#004A99] no-underline whitespace-nowrap"
          >
            Antrian Farmasi
          </Link>
        </div>
